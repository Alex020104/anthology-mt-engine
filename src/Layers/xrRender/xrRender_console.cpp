...
// v95 performs one precise box query per complete renderable after the cheap
// spatial-sphere HOM stage. It no longer repeats the query for every child mesh.
