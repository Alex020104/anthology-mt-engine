...
public:
	...
	void LoadSessionRecordPrecacheScheduler(u64 ticks);
	...
	bool LoadSessionCanReuseStartupLua() const;
...
extern ENGINE_API bool EngineShouldSuppressExplicitLuaJITFlush();
